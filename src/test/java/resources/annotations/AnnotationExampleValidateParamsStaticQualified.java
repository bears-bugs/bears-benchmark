...
public class AnnotationExampleValidateParamsStaticQualified {
	...
	public void test2 (JspWriter out,String selected) throws IOException {
		AnnotationExampleValidateParamsStaticQualified.test1(out, selected); // warning because test1 is sink
	}
}

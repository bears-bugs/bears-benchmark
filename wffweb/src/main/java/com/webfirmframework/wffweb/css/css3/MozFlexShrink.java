...
/**
 * <pre>
 *  -moz-flex-shrink: <i>number</i>|initial|inherit;
 ...
 * Animatable:     yes
 * Version:        CSS3
 * JavaScript syntax:      object.style.mozFlexShrink="5"
 * </pre>
 *
 * @author WFF
 * @since 1.0.0
...
public class MozFlexShrink extends AbstractCssProperty<MozFlexShrink> {
    ...
    public MozFlexShrink(final MozFlexShrink mozFlexShrink) {
        if (mozFlexShrink == null) {
            throw new NullValueException("mozFlexShrink can not be null");
        }
        setCssValue(mozFlexShrink.getCssValue());
    }
    ...
    public String getCssName() {
        return CssNameConstants.MOZ_FLEX_SHRINK;
    }
     ...
     */
    @Override
    public MozFlexShrink setCssValue(final String cssValue) {
        if (cssValue == null) {

 ...
 * Animatable:     yes
 * Version:        CSS3
 * JavaScript syntax:      object.style.webkitFlexGrow="5"
 * </pre>
 *
 * @author WFF
 * @since 1.0.0
...
public class WebkitFlexGrow extends AbstractCssProperty<WebkitFlexGrow> {
     ...
     */
    public WebkitFlexGrow(final String cssValue) {
    ...
    /**
     * gets the webkitFlexGrow in {@code Float} value.
     *
     ...
     */
    @Override
    public WebkitFlexGrow setCssValue(final String cssValue) {
        if (cssValue == null) {

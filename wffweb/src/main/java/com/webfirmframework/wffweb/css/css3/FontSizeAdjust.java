...
/**
 * <pre>
 *  font-size-adjust: <i>number</i>|none|initial|inherit;
 *
...
public class FontSizeAdjust extends AbstractCssProperty<FontSizeAdjust> {
    ...
    /**
     * The default value <code>none</code> will be set as the cssValue.
     *
     * @author WFF
     * @since 1.0.0
     */
     ...
     */
    public FontSizeAdjust(final String cssValue) {
     ...
     */
    public FontSizeAdjust(final FontSizeAdjust fontSizeAdjust) {
        if (fontSizeAdjust == null) {
            throw new NullValueException("fontSizeAdjust can not be null");
        }
        setCssValue(fontSizeAdjust.getCssValue());
    }
    ...
    public String getCssName() {
        return CssNameConstants.FONT_SIZE_ADJUST;
    }
    ...
    /**
     * gets the fontSizeAdjust in {@code Float} value.
     *
     ...
     */
    @Override
    public FontSizeAdjust setCssValue(final String cssValue) {
        if (cssValue == null) {

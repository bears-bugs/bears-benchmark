...
/**
 * <pre>
 *  -webkit-column-count: <i>number</i>|auto|initial|inherit;
 *
...
public class WebkitColumnCount extends AbstractCssProperty<WebkitColumnCount> {
     ...
     */
    public WebkitColumnCount(final String cssValue) {
    ...
    /**
     * gets the webkitColumnCount in {@code Integer} value.
     *
     ...
     */
    @Override
    public WebkitColumnCount setCssValue(final String cssValue) {
        if (cssValue == null) {

 ...
 * Animatable:     yes
 * Version:        CSS1
 * JavaScript syntax:      <i>object</i>.style.borderRightColor="blue"
 * </pre>
 *
 *
 * @author WFF
 * @since 1.0.0
 */
public class BorderRightColor extends AbstractCssProperty<BorderRightColor>
     ...
     */
    public BorderRightColor(final String cssValue) {
        setCssValue(cssValue);
    }

    /**
     * @param borderRightColor
     *            the {@code BorderRightColor} object from which the cssValue to
     *            set.And, {@code null} will throw {@code NullValueException}
     */
    public BorderRightColor(final BorderRightColor borderRightColor) {
        if (borderRightColor == null) {
            throw new NullValueException("borderRightColor can not be null");
        }
        setCssValue(borderRightColor.getCssValue());
    }

    /**
     * @param rgbCssValue
     */
    public BorderRightColor(final RgbCssValue rgbCssValue) {
        super();
     ...
     * @author WFF
     */
    public BorderRightColor setValue(final String value) {
        setCssValue(value);
        return this;
    }
    ...
    public String getCssName() {
        return CssNameConstants.BORDER_RIGHT_COLOR;
    }
     ...
     */
    @Override
    public BorderRightColor setCssValue(final String cssValue) {

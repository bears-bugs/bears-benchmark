 ...
 * Animatable:     yes
 * Version:        CSS1
 * JavaScript syntax:      object.style.marginTop="100px"
 * </pre>
 *
 * @author WFF
 * @since 1.0.0
...
public class MarginTop extends AbstractCssProperty<MarginTop> {
    ...
    /**
     * @param marginTop
     *            the {@code MarginTop} object from which the cssValue to
     *            set.And, {@code null} will throw {@code NullValueException}
     */
    public MarginTop(final MarginTop marginTop) {
        if (marginTop == null) {
            throw new NullValueException("marginTop can not be null");
        }
     ...
     * @author WFF
     */
    public MarginTop(final float percent) {
     ...
     * @param cssLengthUnit
     */
    public MarginTop(final float value, final CssLengthUnit cssLengthUnit) {
        this.value = value;
    ...
    public String getCssName() {
        return CssNameConstants.MARGIN_TOP;
    }
     ...
     */
    @Override
    public MarginTop setCssValue(final String cssValue) {

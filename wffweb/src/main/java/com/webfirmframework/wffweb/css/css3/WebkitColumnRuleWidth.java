 ...
 *
 * The -webkit-column-rule-width property specifies the width of the rule between columns.
...
public class WebkitColumnRuleWidth
    ...
    public WebkitColumnRuleWidth(
        ...
        setCssValue(webkitColumnRuleWidth.getCssValue());
    }
     ...
     * @author WFF
     */
    public WebkitColumnRuleWidth(final float percent) {
    ...
    public String getCssName() {
        return CssNameConstants.WEBKIT_COLUMN_RULE_WIDTH;
    }
     ...
     */
    @Override
    public WebkitColumnRuleWidth setCssValue(final String cssValue) {
        try {
            if (cssValue == null) {

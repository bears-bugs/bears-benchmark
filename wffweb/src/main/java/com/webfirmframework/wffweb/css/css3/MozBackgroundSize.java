 ...
 * Animatable:     yes
 * Version:        CSS3
 * JavaScript syntax:      object.style.mozBackgroundSize="60px 120px"
 * </pre>
 *
 * @author WFF
 * @since 1.0.0
...
public class MozBackgroundSize extends AbstractCssProperty<MozBackgroundSize> {
    ...
    public String getCssName() {
        return CssNameConstants.MOZ_BACKGROUND_SIZE;
    }
     ...
     */
    @Override
    public MozBackgroundSize setCssValue(final String cssValue) {
        try {
            if (cssValue == null) {

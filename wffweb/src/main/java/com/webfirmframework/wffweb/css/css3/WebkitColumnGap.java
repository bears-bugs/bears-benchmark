 ...
 * Animatable:     yes
 * Version:        CSS3
 * JavaScript syntax:      object.style.webkitColumnGap="50px"
 * </pre>
 *
 * @author WFF
 * @since 1.0.0
...
public class WebkitColumnGap extends AbstractCssProperty<WebkitColumnGap> {
    ...
    public WebkitColumnGap(final WebkitColumnGap webkitColumnGap) {
        if (webkitColumnGap == null) {
            throw new NullValueException("webkitColumnGap can not be null");
        }
        setCssValue(webkitColumnGap.getCssValue());
    }
     ...
     * @author WFF
     */
    public WebkitColumnGap(final float percent) {
     ...
     * @param cssLengthUnit
     */
    public WebkitColumnGap(final float value,
     ...
     * @author WFF
     */
    public WebkitColumnGap setValue(final float value,
            final CssLengthUnit cssLengthUnit) {
        this.value = value;
        this.cssLengthUnit = cssLengthUnit;
        cssValue = String.valueOf(value) + cssLengthUnit;
    ...
    public String getCssName() {
        return CssNameConstants.WEBKIT_COLUMN_GAP;
    }
    ...
    /**
     * gets the width in float value. {@code WebkitColumnGap#getUnit()} should
     ...
     */
    @Override
    public WebkitColumnGap setCssValue(final String cssValue) {
        try {
            if (cssValue == null) {

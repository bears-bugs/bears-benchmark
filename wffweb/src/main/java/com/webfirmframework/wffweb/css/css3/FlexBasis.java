...
/**
 * <pre>
 * flex-basis: <i>length</i>|auto|initial|inherit;
 *
...
public class FlexBasis extends AbstractCssProperty<FlexBasis> {
    ...
    /**
     * @param flexBasis
     *            the {@code FlexBasis} object from which the cssValue to
     *            set.And, {@code null} will throw {@code NullValueException}
     */
    public FlexBasis(final FlexBasis flexBasis) {
        if (flexBasis == null) {
            throw new NullValueException("flexBasis can not be null");
        }
        setCssValue(flexBasis.getCssValue());
    }
     ...
     * @author WFF
     */
    public FlexBasis(final float percent) {
     ...
     * @param cssLengthUnit
     */
    public FlexBasis(final float value, final CssLengthUnit cssLengthUnit) {
        this.value = value;
    ...
    public String getCssName() {
        return CssNameConstants.FLEX_BASIS;
    }
     ...
     */
    @Override
    public FlexBasis setCssValue(final String cssValue) {

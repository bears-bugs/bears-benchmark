...
/**
 * <pre>
 * flex-grow: <i>number</i>|initial|inherit;
 *
...
public class FlexGrow extends AbstractCssProperty<FlexGrow> {
    ...
    public FlexGrow(final FlexGrow flexGrow) {
        if (flexGrow == null) {
            throw new NullValueException("flexGrow can not be null");
        }
        setCssValue(flexGrow.getCssValue());
    }
    ...
    public String getCssName() {
        return CssNameConstants.FLEX_GROW;
    }
    ...
    /**
     * gets the flexGrow in {@code Float} value.
     *
     ...
     */
    @Override
    public FlexGrow setCssValue(final String cssValue) {

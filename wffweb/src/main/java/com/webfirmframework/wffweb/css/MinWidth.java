...
public class MinWidth extends AbstractCssProperty<MinWidth> {
     ...
     */
    public MinWidth() {
        cssLengthUnit = CssLengthUnit.PX;
        cssValue = "0" + cssLengthUnit;
    }
     ...
     */
    public MinWidth(final String cssValue) {
        setCssValue(cssValue);
    }

    /**
     * @param minWidth
     *            the {@code MinWidth} object from which the cssValue to
     *            set.And, {@code null} will throw {@code NullValueException}
     */
    public MinWidth(final MinWidth minWidth) {
        if (minWidth == null) {
            throw new NullValueException("minWidth can not be null");
        }
        setCssValue(minWidth.getCssValue());
    }
     ...
     * @author WFF
     */
    public MinWidth(final float percent) {
     ...
     * @param cssLengthUnit
     */
    public MinWidth(final float value, final CssLengthUnit cssLengthUnit) {
        this.value = value;
     ...
     * @author WFF
     */
    public MinWidth setValue(final float value,
    ...
    public String getCssName() {
        return CssNameConstants.MIN_WIDTH;
    }
    ...
    /**
     * gets the min-width in float value. {@code MinWidth#getUnit()} should be
     ...
     */
    @Override
    public MinWidth setCssValue(final String cssValue) {
        try {
            if (cssValue == null) {

 ...
 * Animatable:     yes
 * Version:        CSS1
 * JavaScript syntax:      object.style.paddingTop="50px"
 * </pre>
 *
 * @author WFF
 * @since 1.0.0
 */
public class PaddingTop extends AbstractCssProperty<PaddingTop> {
     ...
     */
    public PaddingTop(final String cssValue) {
        setCssValue(cssValue);
    }

    /**
     * @param paddingTop
     *            the {@code PaddingTop} object from which the cssValue to
     *            set.And, {@code null} will throw {@code NullValueException}
     */
    public PaddingTop(final PaddingTop paddingTop) {
        if (paddingTop == null) {
            throw new NullValueException("paddingTop can not be null");
        }
     ...
     * @author WFF
     */
    public PaddingTop(final float percent) {
     ...
     * @param cssLengthUnit
     */
    public PaddingTop(final float value, final CssLengthUnit cssLengthUnit) {
        this.value = value;
     ...
     * @author WFF
     */
    public PaddingTop setValue(final float value,
    ...
    public String getCssName() {
        return CssNameConstants.PADDING_TOP;
    }
    ...
    /**
     * gets the width in float value. {@code PaddingTop#getUnit()} should be
     ...
     */
    @Override
    public PaddingTop setCssValue(final String cssValue) {
                ...
                for (final CssLengthUnit cssLengthUnit : CssLengthUnit
                    ...
                    if (trimmedCssValue.endsWith(unit)) {
                        ...
                        try {
                            ...
                            // "paddingTop cannot be a negative value");
                            // }

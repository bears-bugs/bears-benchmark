 ...
 * Animatable:     yes
 * Version:        CSS1
 * JavaScript syntax:      object.style.paddingBottom="50px"
 * </pre>
 *
 * @author WFF
 * @since 1.0.0
 */
public class PaddingBottom extends AbstractCssProperty<PaddingBottom> {
     ...
     */
    public PaddingBottom(final String cssValue) {
     ...
     */
    public PaddingBottom(final PaddingBottom paddingBottom) {
     ...
     * @author WFF
     */
    public PaddingBottom(final float percent) {
     ...
     * @param cssLengthUnit
     */
    public PaddingBottom(final float value, final CssLengthUnit cssLengthUnit) {
        this.value = value;
     ...
     * @author WFF
     */
    public PaddingBottom setValue(final float value,
    ...
    public String getCssName() {
        return CssNameConstants.PADDING_BOTTOM;
    }
    ...
    /**
     * gets the width in float value. {@code PaddingBottom#getUnit()} should be
     ...
     */
    @Override
    public PaddingBottom setCssValue(final String cssValue) {
                ...
                for (final CssLengthUnit cssLengthUnit : CssLengthUnit
                    ...
                    if (trimmedCssValue.endsWith(unit)) {
                        ...
                        try {
                            ...
                            // "paddingBottom cannot be a negative value");
                            // }

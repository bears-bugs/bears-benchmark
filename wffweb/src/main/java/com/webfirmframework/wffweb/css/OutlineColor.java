...
public class OutlineColor extends AbstractCssProperty<OutlineColor>
    ...
    /**
     * The {@code invert} will be set as the value
     */
    public OutlineColor() {
        setCssValue(INVERT);
    }
     ...
     */
    public OutlineColor(final String cssValue) {
        setCssValue(cssValue);
    }

    /**
     * @param outlineColor
     *            the {@code OutlineColor} object from which the cssValue to
     *            set.And, {@code null} will throw {@code NullValueException}
     */
    public OutlineColor(final OutlineColor outlineColor) {
        if (outlineColor == null) {
            throw new NullValueException("outlineColor can not be null");
        }
        setCssValue(outlineColor.getCssValue());
    }

    /**
     * @param rgbCssValue
     */
    public OutlineColor(final RgbCssValue rgbCssValue) {
     ...
     * @author WFF
     */
    public OutlineColor setValue(final String value) {
        setCssValue(value);
        return this;
    }
    ...
    public String getCssName() {
        return CssNameConstants.OUTLINE_COLOR;
    }
     ...
     */
    @Override
    public OutlineColor setCssValue(final String cssValue) {
        if (cssValue == null) {

 ...
 *
 * For relatively positioned elements, the right property sets the right edge of an element to a unit above/below its normal position.
 *
 ...
 * @since 1.0.0
 */
public class Right extends AbstractCssProperty<Right> {
     ...
     */
    public Right(final String cssValue) {
     ...
     */
    public Right(final Right right) {
        if (right == null) {
            throw new NullValueException("right can not be null");
        }
        setCssValue(right.getCssValue());
    }
     ...
     * @author WFF
     */
    public Right(final float percent) {
     ...
     * @param cssLengthUnit
     */
    public Right(final float value, final CssLengthUnit cssLengthUnit) {
        this.value = value;
     ...
     * @author WFF
     */
    public Right setValue(final float value,
    ...
    /**
     * gets the width in float value. {@code Right#getUnit()} should be used to
     ...
     */
    @Override
    public Right setCssValue(final String cssValue) {

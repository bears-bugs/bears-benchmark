 ...
 * Animatable:     yes
 * Version:        CSS1
 * JavaScript syntax:      <i>object</i>.style.borderTopWidth="5px"
 * </pre>
 *
 *
 * @author WFF
 * @since 1.0.0
 */
public class BorderTopWidth extends AbstractCssProperty<BorderTopWidth> {
    ...
    public BorderTopWidth(final BorderTopWidth borderTopWidth) {
        if (borderTopWidth == null) {
            throw new NullValueException("borderTopWidth can not be null");
        }
     ...
     * @param cssLengthUnit
     */
    public BorderTopWidth(final float value,
     ...
     * @author WFF
     */
    public BorderTopWidth setValue(final float value,
            final CssLengthUnit cssLengthUnit) {
        this.value = value;
        this.cssLengthUnit = cssLengthUnit;
        cssValue = String.valueOf(value) + cssLengthUnit;
    ...
    public String getCssName() {
        return CssNameConstants.BORDER_TOP_WIDTH;
    }
    ...
    /**
     * gets the border-top-width in {@code Float} value.
     * {@code BorderTopWidth#getUnit()} should be used to get the cssLengthUnit
     * for this value.
     *
     ...
     */
    @Override
    public BorderTopWidth setCssValue(final String cssValue) {

 ...
 * Animatable:     yes
 * Version:        CSS3
 * JavaScript syntax:      object.style.mozColumnGap="50px"
 * </pre>
 *
 * @author WFF
 * @since 1.0.0
 */
public class MozColumnGap extends AbstractCssProperty<MozColumnGap> {
    ...
    /**
     * @param mozColumnGap
     *            the {@code MozColumnGap} object from which the cssValue to
     *            set.And, {@code null} will throw {@code NullValueException}
     */
    public MozColumnGap(final MozColumnGap mozColumnGap) {
        if (mozColumnGap == null) {
            throw new NullValueException("mozColumnGap can not be null");
        }
        setCssValue(mozColumnGap.getCssValue());
    }
     ...
     * @author WFF
     */
    public MozColumnGap(final float percent) {
     ...
     * @param cssLengthUnit
     */
    public MozColumnGap(final float value, final CssLengthUnit cssLengthUnit) {
        this.value = value;
    ...
    public String getCssName() {
        return CssNameConstants.MOZ_COLUMN_GAP;
    }
     ...
     */
    @Override
    public MozColumnGap setCssValue(final String cssValue) {
        try {
            if (cssValue == null) {

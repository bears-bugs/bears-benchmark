 ...
 * Animatable:     yes
 * Version:        CSS1
 * JavaScript syntax:      object.style.paddingRight="50px"
 * </pre>
 *
 * @author WFF
 * @since 1.0.0
 */
public class PaddingRight extends AbstractCssProperty<PaddingRight> {
     ...
     */
    public PaddingRight(final String cssValue) {
     ...
     */
    public PaddingRight(final PaddingRight paddingRight) {
        if (paddingRight == null) {
            throw new NullValueException("paddingRight can not be null");
        }
        setCssValue(paddingRight.getCssValue());
    }
     ...
     * @author WFF
     */
    public PaddingRight(final float percent) {
     ...
     * @param cssLengthUnit
     */
    public PaddingRight(final float value, final CssLengthUnit cssLengthUnit) {
        this.value = value;
     ...
     * @author WFF
     */
    public PaddingRight setValue(final float value,
    ...
    public String getCssName() {
        return CssNameConstants.PADDING_RIGHT;
    }
    ...
    /**
     * gets the width in float value. {@code PaddingRight#getUnit()} should be
     ...
     */
    @Override
    public PaddingRight setCssValue(final String cssValue) {
                ...
                for (final CssLengthUnit cssLengthUnit : CssLengthUnit
                    ...
                    if (trimmedCssValue.endsWith(unit)) {
                        ...
                        try {
                            ...
                            // "paddingRight cannot be a negative value");
                            // }

...
public class MaxWidth extends AbstractCssProperty<MaxWidth> {
    ...
    public MaxWidth(final MaxWidth maxWidth) {
        if (maxWidth == null) {
            throw new NullValueException("maxWidth can not be null");
        }
        setCssValue(maxWidth.getCssValue());
    }
     ...
     * @author WFF
     */
    public MaxWidth(final float percent) {
        cssLengthUnit = CssLengthUnit.PER;
        value = percent;
     ...
     * @param cssLengthUnit
     */
    public MaxWidth(final float value, final CssLengthUnit cssLengthUnit) {
        this.value = value;
    ...
    public String getCssName() {
        return CssNameConstants.MAX_WIDTH;
    }
     ...
     */
    @Override
    public MaxWidth setCssValue(final String cssValue) {
        try {
            if (cssValue == null) {

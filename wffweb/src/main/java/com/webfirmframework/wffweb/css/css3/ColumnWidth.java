...
public class ColumnWidth extends AbstractCssProperty<ColumnWidth> {
    ...
    public ColumnWidth(final ColumnWidth columnWidth) {
        if (columnWidth == null) {
            throw new NullValueException("columnWidth can not be null");
        }
        setCssValue(columnWidth.getCssValue());
    }
     ...
     * @author WFF
     */
    public ColumnWidth(final float percent) {
     ...
     * @param cssLengthUnit
     */
    public ColumnWidth(final float value, final CssLengthUnit cssLengthUnit) {
        this.value = value;
     ...
     * @author WFF
     */
    public ColumnWidth setValue(final float value,
    ...
    public String getCssName() {
        return CssNameConstants.COLUMN_WIDTH;
    }
    ...
    /**
     * gets the column-width in float value. {@code ColumnWidth#getUnit()}
     ...
     */
    @Override
    public ColumnWidth setCssValue(final String cssValue) {

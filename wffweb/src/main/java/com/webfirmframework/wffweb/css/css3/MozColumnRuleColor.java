...
public class MozColumnRuleColor
     ...
     *            the {@code MozColumnRuleColor} object from which the cssValue
     ...
     * @author WFF
     */
    public MozColumnRuleColor setValue(final String value) {
        setCssValue(value);
        return this;
    }
     ...
     */
    @Override
    public MozColumnRuleColor setCssValue(final String cssValue) {
        if (cssValue == null) {

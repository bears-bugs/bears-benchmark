 ...
 * <pre>
 *
 * border-image-source: none|<i>image</i>|initial|inherit;
 *
...
public class BorderImageSource extends AbstractCssProperty<BorderImageSource>
     ...
     *            the {@code BorderImageSource} object from which the cssName
     *            and cssValue to set.
     * @author WFF
     */
     ...
     * @author WFF
     */
    public BorderImageSource(final String... imageUrls) {
    ...
    public String getCssName() {
        return CssNameConstants.BORDER_IMAGE_SOURCE;
    }
     ...
     */
    @Override
    public BorderImageSource setCssValue(final String cssValue) {

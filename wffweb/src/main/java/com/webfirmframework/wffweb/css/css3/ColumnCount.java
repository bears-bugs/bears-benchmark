...
/**
 * <pre>
 *  column-count: <i>number</i>|auto|initial|inherit;
 *
...
public class ColumnCount extends AbstractCssProperty<ColumnCount> {
     ...
     */
    public ColumnCount(final String cssValue) {
     ...
     */
    public ColumnCount(final ColumnCount columnCount) {
        if (columnCount == null) {
            throw new NullValueException("columnCount can not be null");
        }
        setCssValue(columnCount.getCssValue());
    }
    ...
    public String getCssName() {
        return CssNameConstants.COLUMN_COUNT;
    }
    ...
    /**
     * gets the columnCount in {@code Integer} value.
     *
     ...
     */
    @Override
    public ColumnCount setCssValue(final String cssValue) {

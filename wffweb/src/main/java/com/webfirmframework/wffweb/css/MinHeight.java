...
public class MinHeight extends AbstractCssProperty<MinHeight> {
    ...
    /**
     * @param minHeight
     *            the {@code MinHeight} object from which the cssValue to
     *            set.And, {@code null} will throw {@code NullValueException}
     */
    public MinHeight(final MinHeight minHeight) {
        if (minHeight == null) {
            throw new NullValueException("minHeight can not be null");
        }
        setCssValue(minHeight.getCssValue());
    }
     ...
     * @author WFF
     */
    public MinHeight(final float percent) {
     ...
     * @param cssLengthUnit
     */
    public MinHeight(final float value, final CssLengthUnit cssLengthUnit) {
        this.value = value;
    ...
    public String getCssName() {
        return CssNameConstants.MIN_HEIGHT;
    }
     ...
     */
    @Override
    public MinHeight setCssValue(final String cssValue) {
        try {
            if (cssValue == null) {

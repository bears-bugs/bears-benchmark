...
public class BorderImageWidth extends AbstractCssProperty<BorderImageWidth> {
     ...
     */
    public BorderImageWidth(final String cssValue) {
     ...
     */
    public BorderImageWidth(final BorderImageWidth bottom) {
        if (bottom == null) {
     ...
     * @author WFF
     */
    public BorderImageWidth(final float percent) {
    ...
    public String getCssName() {
        return CssNameConstants.BORDER_IMAGE_WIDTH;
    }
     ...
     */
    @Override
    public BorderImageWidth setCssValue(final String cssValue) {
        if (cssValue == null) {
    ...
    public static boolean isValid(final String cssValue) {
        ...
        for (final String cssValuePart : cssValueParts) {
            ...
            if (lengthValueAndUnit.length == 0 && !AUTO.equals(cssValuePart)) {
                return false;
            }
        }
        return true;

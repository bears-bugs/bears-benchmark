 ...
 * <pre>
 *
 * flex: <i>flex-grow flex-shrink flex-basis</i>|auto|initial|inherit;
 *
...
public class Flex extends AbstractCssProperty<Flex>
     ...
     */
    @Override
    public Flex setCssValue(final String cssValue) {
    ...
    public Flex setFlexGrow(final FlexGrow flexGrow) {
        if (flexGrow == null) {
    ...
    public Flex setFlexShrink(final FlexShrink flexShrink) {
        if (flexShrink == null) {
    ...
    public Flex setFlexBasis(final FlexBasis flexBasis) {
        if (flexBasis == null) {

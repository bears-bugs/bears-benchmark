 ...
 * Animatable:     yes
 * Version:        CSS1
 * JavaScript syntax:      object.style.marginLeft="100px"
 * </pre>
 *
 * @author WFF
 * @since 1.0.0
...
public class MarginLeft extends AbstractCssProperty<MarginLeft> {
    ...
    public MarginLeft(final MarginLeft marginLeft) {
        if (marginLeft == null) {
            throw new NullValueException("marginLeft can not be null");
        }
        setCssValue(marginLeft.getCssValue());
    }
     ...
     * @author WFF
     */
    public MarginLeft(final float percent) {
     ...
     * @param cssLengthUnit
     */
    public MarginLeft(final float value, final CssLengthUnit cssLengthUnit) {
        this.value = value;
    ...
    public String getCssName() {
        return CssNameConstants.MARGIN_LEFT;
    }
     ...
     */
    @Override
    public MarginLeft setCssValue(final String cssValue) {

 ...
 * Animatable:     yes
 * Version:        CSS1
 * JavaScript syntax:      object.style.marginBottom="100px"
 * </pre>
 *
 * @author WFF
 * @since 1.0.0
...
public class MarginBottom extends AbstractCssProperty<MarginBottom> {
    ...
    public String getCssName() {
        return CssNameConstants.MARGIN_BOTTOM;
    }
     ...
     */
    @Override
    public MarginBottom setCssValue(final String cssValue) {
                ...
                for (final CssLengthUnit cssLengthUnit : CssLengthUnit
                    ...
                    if (trimmedCssValue.endsWith(unit)) {
                        ...
                        try {
                            ...
                            // "marginBottom cannot be a negative value");
                            // }

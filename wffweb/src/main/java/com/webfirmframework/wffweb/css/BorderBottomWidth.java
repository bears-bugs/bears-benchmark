 ...
 * Animatable:     yes
 * Version:        CSS1
 * JavaScript syntax:      <i>object</i>.style.borderBottomWidth="5px"
 * </pre>
 *
 *
 * @author WFF
...
public class BorderBottomWidth extends AbstractCssProperty<BorderBottomWidth> {
     ...
     */
    public BorderBottomWidth(final String cssValue) {
     ...
     */
    public BorderBottomWidth(final BorderBottomWidth borderBottomWidth) {
     ...
     * @author WFF
     */
    public BorderBottomWidth(final float percent) {
        cssLengthUnit = CssLengthUnit.PER;
        value = Float.valueOf(percent);
     ...
     * @param cssLengthUnit
     */
    public BorderBottomWidth(final float value,
     ...
     * @author WFF
     */
    public BorderBottomWidth setValue(final float value,
            final CssLengthUnit cssLengthUnit) {
        this.value = Float.valueOf(value);
        this.cssLengthUnit = cssLengthUnit;
        cssValue = String.valueOf(value).concat(cssLengthUnit.toString());
    ...
    public String getCssName() {
        return CssNameConstants.BORDER_BOTTOM_WIDTH;
    }
    ...
    /**
     * gets the border-bottom-width in {@code Float} value.
     * {@code BorderBottomWidth#getUnit()} should be used to get the
     * cssLengthUnit for this value.
     *
     * @return the value in <code>Float</code> or null if the
     *         border-bottom-width is set as <code>initial</code> or
     *         <code>inherit</code>.
     * @since 1.0.0
     * @author WFF
     */
     ...
     */
    @Override
    public BorderBottomWidth setCssValue(final String cssValue) {

...
public class ColumnRuleColor extends AbstractCssProperty<ColumnRuleColor> {
    ...
    public ColumnRuleColor(final ColumnRuleColor columnRuleColor) {
        ...
        setCssValue(columnRuleColor.getCssValue());
    }
     ...
     * @author WFF
     */
    public ColumnRuleColor setValue(final String value) {
        setCssValue(value);
        return this;
    }
    ...
    public String getCssName() {
        return CssNameConstants.COLUMN_RULE_COLOR;
    }
     ...
     */
    @Override
    public ColumnRuleColor setCssValue(final String cssValue) {
        if (cssValue == null) {

...
/**
 * <pre>
 * border-bottom-color: <i>color</i>|transparent|initial|inherit;
 *
 ...
 * Animatable:     yes
 * Version:        CSS1
 * JavaScript syntax:     <i>object</i>.style.borderBottomColor="blue"
 * </pre>
 *
 *
 * @author WFF
...
public class BorderBottomColor extends AbstractCssProperty<BorderBottomColor>
     ...
     * @param rgbCssValue
     */
    public BorderBottomColor(final RgbCssValue rgbCssValue) {
        super();
     ...
     * @author WFF
     */
    public BorderBottomColor setValue(final String value) {
        setCssValue(value);
        return this;
    }
    ...
    public String getCssName() {
        return CssNameConstants.BORDER_BOTTOM_COLOR;
    }
     ...
     */
    @Override
    public BorderBottomColor setCssValue(final String cssValue) {

 ...
 * @since 1.0.0
 */
public enum WebkitBackfaceVisibility implements CssProperty {

    VISIBLE, HIDDEN, INITIAL, INHERITS;
    ...
    private WebkitBackfaceVisibility() {
    }
    ...
    public String getCssName() {
        return CssNameConstants.WEBKIT_BACKFACE_VISIBILITY;
    }

 ...
 *
 * The -moz-column-width property specifies the width of the columns.
 * Default value:  auto
 * Inherited:      no
 * Animatable:     yes
 * Version:        CSS3
 ...
 * @since 1.0.0
 */
public class MozColumnWidth extends AbstractCssProperty<MozColumnWidth> {
     ...
     *            the {@code MozColumnWidth} object from which the cssValue to
     *            set.And, {@code null} will throw {@code NullValueException}
     */
    public MozColumnWidth(final MozColumnWidth mozColumnWidth) {
        if (mozColumnWidth == null) {
            throw new NullValueException("mozColumnWidth can not be null");
        }
        setCssValue(mozColumnWidth.getCssValue());
    }
     ...
     * @author WFF
     */
    public MozColumnWidth(final float percent) {
    ...
    public String getCssName() {
        return CssNameConstants.MOZ_COLUMN_WIDTH;
    }
     ...
     */
    @Override
    public MozColumnWidth setCssValue(final String cssValue) {
        try {
            if (cssValue == null) {

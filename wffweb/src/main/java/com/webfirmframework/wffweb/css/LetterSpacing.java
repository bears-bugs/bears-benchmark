...
public class LetterSpacing extends AbstractCssProperty<LetterSpacing> {
     ...
     */
    public LetterSpacing(final String cssValue) {
     ...
     */
    public LetterSpacing(final LetterSpacing letterSpacing) {
        if (letterSpacing == null) {
            throw new NullValueException("letterSpacing can not be null");
        }
        setCssValue(letterSpacing.getCssValue());
    }
     ...
     * @author WFF
     */
    public LetterSpacing(final float percent) {
     ...
     * @param cssLengthUnit
     */
    public LetterSpacing(final float value, final CssLengthUnit cssLengthUnit) {
        this.value = value;
     ...
     * @author WFF
     */
    public LetterSpacing setValue(final float value,
    ...
    public String getCssName() {
        return CssNameConstants.LETTER_SPACING;
    }
    ...
    /**
     * gets the width in float value. {@code LetterSpacing#getUnit()} should be
     ...
     */
    @Override
    public LetterSpacing setCssValue(final String cssValue) {
                ...
                for (final CssLengthUnit cssLengthUnit : CssLengthUnit
                    ...
                    if (trimmedCssValue.endsWith(unit)) {
                        ...
                        try {
                            ...
                            // "letterSpacing cannot be a negative value");
                            // }

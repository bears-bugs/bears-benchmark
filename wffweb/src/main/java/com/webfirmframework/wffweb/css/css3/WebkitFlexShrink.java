...
/**
 * <pre>
 *  -webkit-flex-shrink: <i>number</i>|initial|inherit;
...
public class WebkitFlexShrink extends AbstractCssProperty<WebkitFlexShrink> {
     ...
     */
    public WebkitFlexShrink(final String cssValue) {
    ...
    public WebkitFlexShrink(final WebkitFlexShrink webkitFlexShrink) {
        if (webkitFlexShrink == null) {
            throw new NullValueException("webkitFlexShrink can not be null");
        }
        setCssValue(webkitFlexShrink.getCssValue());
    }
    ...
    public String getCssName() {
        return CssNameConstants.WEBKIT_FLEX_SHRINK;
    }
    ...
    /**
     * gets the webkitFlexShrink in {@code Float} value.
     *
     ...
     */
    @Override
    public WebkitFlexShrink setCssValue(final String cssValue) {
        if (cssValue == null) {

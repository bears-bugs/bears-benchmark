...
/**
 *
 * <code>ontimeupdate</code> attribute for the element. This attribute is
 ...
 *
 */
public class OnTimeUpdate extends AbstractEventAttribute {
    ...
    public OnTimeUpdate(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnTimeUpdate(final String preJsFunctionBody,
    ...
    public OnTimeUpdate(final String value) {

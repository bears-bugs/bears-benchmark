...
/**
 *
 * <code>onabort</code> attribute for the element. This attribute is supported
 * by multiple tags.
 *
 * @since 2.0.0
 * @author WFF
 *
 */
public class OnAbort extends AbstractEventAttribute
    ...
    public OnAbort(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnAbort(final String preJsFunctionBody,
    ...
    public OnAbort(final String value) {

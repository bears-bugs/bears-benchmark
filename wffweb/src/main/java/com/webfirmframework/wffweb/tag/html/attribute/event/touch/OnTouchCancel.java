...
/**
 *
 * <code>ontouchcancel</code> attribute for the element. This attribute is
 ...
 *
 */
public class OnTouchCancel extends AbstractEventAttribute {
    ...
    public OnTouchCancel(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnTouchCancel(final String preJsFunctionBody,
    ...
    public OnTouchCancel(final String value) {

...
/**
 *
 * <code>ondragover</code> attribute for the element. This attribute is
...
public class OnDragOver extends AbstractEventAttribute {
    ...
    public OnDragOver(final ServerAsyncMethod serverAsyncMethod) {
    ...
    public OnDragOver(final String value) {

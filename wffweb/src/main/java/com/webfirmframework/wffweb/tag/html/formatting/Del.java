...
import com.webfirmframework.wffweb.tag.html.identifier.DelAttributable;
...
public class Del extends AbstractHtml {
    ...
    public Del(final AbstractHtml base, final AbstractAttribute... attributes) {
        super(TagNameConstants.DEL, base, attributes);
    ...
    private static void warnForUnsupportedAttributes(
        ...
        for (final AbstractAttribute abstractAttribute : attributes) {
            if (!(abstractAttribute != null
                    && (abstractAttribute instanceof DelAttributable

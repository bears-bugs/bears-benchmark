...
import com.webfirmframework.wffweb.tag.html.html5.identifier.AsideAttributable;
...
public class Aside extends AbstractHtml {
    ...
    public Aside(final AbstractHtml base,
        ...
        super(TagNameConstants.ASIDE, base, attributes);
    ...
    private static void warnForUnsupportedAttributes(
        ...
        for (final AbstractAttribute abstractAttribute : attributes) {
            if (!(abstractAttribute != null
                    && (abstractAttribute instanceof AsideAttributable

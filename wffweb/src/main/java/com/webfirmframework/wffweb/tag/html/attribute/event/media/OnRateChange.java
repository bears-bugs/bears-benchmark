...
/**
 *
 * <code>onratechange</code> attribute for the element. This attribute is
...
public class OnRateChange extends AbstractEventAttribute {
    ...
    public OnRateChange(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnRateChange(final String preJsFunctionBody,
    ...
    public OnRateChange(final String value) {

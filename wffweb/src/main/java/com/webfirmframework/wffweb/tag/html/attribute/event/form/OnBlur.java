...
/**
 *
 * <code>onblur</code> attribute for the element. This attribute is supported by
 * multiple tags.
 *
 * @since 2.0.0
 * @author WFF
...
public class OnBlur extends AbstractEventAttribute implements AAttributable {
    ...
    public OnBlur(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnBlur(final String preJsFunctionBody,
    ...
    public OnBlur(final String value) {

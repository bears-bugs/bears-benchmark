...
/**
 *
 * <code>onpaste</code> attribute for the element. This attribute is supported
 * by multiple tags.
 *
 * @since 2.0.0
 * @author WFF
...
public class OnPaste extends AbstractEventAttribute {
    ...
    public OnPaste(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnPaste(final String preJsFunctionBody,
    ...
    public OnPaste(final String value) {

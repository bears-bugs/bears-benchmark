 ...
 *
 */
public class OnMouseEnter extends AbstractEventAttribute
    ...
    public OnMouseEnter(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnMouseEnter(final String preJsFunctionBody,
    ...
    public OnMouseEnter(final String value) {

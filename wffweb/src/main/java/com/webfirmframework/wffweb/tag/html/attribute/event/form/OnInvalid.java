...
/**
 *
 * <code>oninvalid</code> attribute for the element. This attribute is supported
 * by multiple tags.
 *
 * @since 2.0.0
 * @author WFF
 *
 */
public class OnInvalid extends AbstractEventAttribute implements AAttributable {
    ...
    public OnInvalid(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnInvalid(final String preJsFunctionBody,
    ...
    public OnInvalid(final String value) {

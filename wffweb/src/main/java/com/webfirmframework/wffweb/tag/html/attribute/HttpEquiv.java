...
/**
 *
 * <code>http-equiv</code> attribute for the element.
 *
 * @since 1.1.2
 * @author WFF
 *
 */
public class HttpEquiv extends AbstractAttribute implements MetaAttributable {
     ...
     * @author WFF
     */
    public HttpEquiv(final String value) {

...
/**
 *
 * <code>ondragenter</code> attribute for the element. This attribute is
 ...
 *
 */
public class OnDragEnter extends AbstractEventAttribute {
    ...
    public OnDragEnter(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnDragEnter(final String preJsFunctionBody,
    ...
    public OnDragEnter(final String value) {

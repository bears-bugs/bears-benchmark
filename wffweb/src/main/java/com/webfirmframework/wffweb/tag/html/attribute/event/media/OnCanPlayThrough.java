...
/**
 *
 * <code>oncanplaythrough</code> attribute for the element. This attribute is
...
public class OnCanPlayThrough extends AbstractEventAttribute {
    ...
    public OnCanPlayThrough(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnCanPlayThrough(final String preJsFunctionBody,
    ...
    public OnCanPlayThrough(final String value) {

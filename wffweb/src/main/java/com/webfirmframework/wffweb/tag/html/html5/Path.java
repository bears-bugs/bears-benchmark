...
import com.webfirmframework.wffweb.tag.html.html5.identifier.PathAttributable;
 ...
 *
 */
public class Path extends AbstractHtml {
    ...
    private static void warnForUnsupportedAttributes(
        ...
        for (final AbstractAttribute abstractAttribute : attributes) {
            if (!(abstractAttribute != null
                    && (abstractAttribute instanceof PathAttributable

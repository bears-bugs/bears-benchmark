...
/**
 *
 * <code>onsuspend</code> attribute for the element. This attribute is supported
 * by multiple tags.
 *
 * @since 2.0.0
 * @author WFF
 *
 */
public class OnSuspend extends AbstractEventAttribute {
    ...
    public OnSuspend(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnSuspend(final String preJsFunctionBody,
    ...
    public OnSuspend(final String value) {

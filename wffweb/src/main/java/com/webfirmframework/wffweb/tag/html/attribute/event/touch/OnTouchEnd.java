...
/**
 *
 * <code>ontouchend</code> attribute for the element. This attribute is
 ...
 *
 */
public class OnTouchEnd extends AbstractEventAttribute {
    ...
    public OnTouchEnd(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnTouchEnd(final String preJsFunctionBody,
    ...
    public OnTouchEnd(final String value) {

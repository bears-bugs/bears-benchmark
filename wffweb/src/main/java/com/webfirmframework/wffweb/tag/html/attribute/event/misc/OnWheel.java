...
/**
 *
 * <code>onwheel</code> attribute for the element. This attribute is supported
 * by multiple tags.
 *
 * @since 2.0.0
 * @author WFF
...
public class OnWheel extends AbstractEventAttribute {
    ...
    public OnWheel(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnWheel(final String preJsFunctionBody,
    ...
    public OnWheel(final String value) {

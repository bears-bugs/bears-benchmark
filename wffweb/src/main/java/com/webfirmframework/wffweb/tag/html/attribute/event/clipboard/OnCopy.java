 ...
 * @author WFF
 */
package com.webfirmframework.wffweb.tag.html.attribute.event.clipboard;
...
/**
 *
 * <code>oncopy</code> attribute for the element. This attribute is supported by
 * multiple tags.
 *
 * @since 2.0.0
 * @author WFF
 *
 */
public class OnCopy extends AbstractEventAttribute {

    private static final long serialVersionUID = 1_0_0L;

    {
        super.setAttributeName(AttributeNameConstants.ONCOPY);
        init();
    }
    ...
    public OnCopy(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnCopy(final String preJsFunctionBody,

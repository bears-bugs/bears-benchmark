...
/**
 *
 * <code>onkeyup</code> attribute for the element. This attribute is supported
 * by multiple tags.
 *
 * @since 2.0.0
 * @author WFF
 *
 */
public class OnKeyUp extends AbstractEventAttribute
    ...
    public OnKeyUp(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnKeyUp(final String preJsFunctionBody,
    ...
    public OnKeyUp(final String value) {

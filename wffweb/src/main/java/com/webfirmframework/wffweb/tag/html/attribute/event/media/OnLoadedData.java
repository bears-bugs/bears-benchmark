...
/**
 *
 * <code>onloadeddata</code> attribute for the element. This attribute is
 ...
 *
 */
public class OnLoadedData extends AbstractEventAttribute {

    private static final long serialVersionUID = 1_0_0L;

    {
        super.setAttributeName(AttributeNameConstants.ONLOADEDDATA);
        init();
    }
    ...
    public OnLoadedData(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnLoadedData(final String preJsFunctionBody,
    ...
    public OnLoadedData(final String value) {

...
/**
 *
 * <code>onloadedmetadata</code> attribute for the element. This attribute is
 ...
 *
 */
public class OnLoadedMetaData extends AbstractEventAttribute {
    ...
    public OnLoadedMetaData(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnLoadedMetaData(final String preJsFunctionBody,
    ...
    public OnLoadedMetaData(final String value) {

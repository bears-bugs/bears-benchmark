...
/**
 *
 * <code>onvolumechange</code> attribute for the element. This attribute is
 ...
 *
 */
public class OnVolumeChange extends AbstractEventAttribute {

    private static final long serialVersionUID = 1_0_0L;

    {
        super.setAttributeName(AttributeNameConstants.ONVOLUMECHANGE);
        init();
    }
    ...
    public OnVolumeChange(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnVolumeChange(final String preJsFunctionBody,
    ...
    public OnVolumeChange(final String value) {

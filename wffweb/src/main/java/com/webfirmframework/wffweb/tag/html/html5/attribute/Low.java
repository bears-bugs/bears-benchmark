...
/**
 *
 * <code>low</code> attribute for <code>meter</code> tag.
 *
 * @author WFF
 * @since 2.1.9
 */
public class Low extends AbstractAttribute implements MeterAttributable {

    private static final long serialVersionUID = 1_0_0L;

    {
        super.setAttributeName(AttributeNameConstants.LOW);
        init();
    }

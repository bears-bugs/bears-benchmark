...
/**
 *
 * <code>onkeypress</code> attribute for the element. This attribute is
 ...
 *
 */
public class OnKeyPress extends AbstractEventAttribute
    ...
    public OnKeyPress(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnKeyPress(final String preJsFunctionBody,
    ...
    public OnKeyPress(final String value) {

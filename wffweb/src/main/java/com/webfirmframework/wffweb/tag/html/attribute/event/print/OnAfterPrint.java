...
/**
 *
 * <code>onafterprint</code> attribute for the element. This attribute is
 ...
 *
 */
public class OnAfterPrint extends AbstractEventAttribute {
    ...
    public OnAfterPrint(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnAfterPrint(final String preJsFunctionBody,
    ...
    public OnAfterPrint(final String value) {

...
/**
 *
 * <code>onoffline</code> attribute for the element. This attribute is supported
 * by multiple tags.
 *
 * @since 2.0.0
 * @author WFF
 *
 */
public class OnOffline extends AbstractEventAttribute {
    ...
    public OnOffline(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnOffline(final String preJsFunctionBody,
    ...
    public OnOffline(final String value) {

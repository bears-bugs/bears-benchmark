...
/**
 *
 * <code>oncanplay</code> attribute for the element. This attribute is supported
 * by multiple tags.
 *
 * @since 2.0.0
 * @author WFF
 *
 */
public class OnCanPlay extends AbstractEventAttribute {
    ...
    public OnCanPlay(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnCanPlay(final String preJsFunctionBody,
    ...
    public OnCanPlay(final String value) {

...
/**
 *
 * <code>oncut</code> attribute for the element. This attribute is supported by
 * multiple tags.
 *
 * @since 2.0.0
 * @author WFF
 *
 */
public class OnCut extends AbstractEventAttribute {
    ...
    public OnCut(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnCut(final String preJsFunctionBody,
    ...
    public OnCut(final String value) {

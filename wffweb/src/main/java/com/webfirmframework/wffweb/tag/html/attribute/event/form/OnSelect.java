...
/**
 *
 * <code>onselect</code> attribute for the element. This attribute is supported
 * by multiple tags.
 *
 * @since 2.0.0
 * @author WFF
...
public class OnSelect extends AbstractEventAttribute implements AAttributable {
    ...
    {
        super.setAttributeName(AttributeNameConstants.ONSELECT);
        init();
    }
    ...
    public OnSelect(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnSelect(final String preJsFunctionBody,
    ...
    public OnSelect(final String value) {

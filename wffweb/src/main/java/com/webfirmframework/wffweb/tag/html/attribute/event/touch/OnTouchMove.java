...
/**
 *
 * <code>ontouchmove</code> attribute for the element. This attribute is
...
public class OnTouchMove extends AbstractEventAttribute {
    ...
    {
        super.setAttributeName(AttributeNameConstants.ONTOUCHMOVE);
        init();
    }
    ...
    public OnTouchMove(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnTouchMove(final String preJsFunctionBody,
    ...
    public OnTouchMove(final String value) {

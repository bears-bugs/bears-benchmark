...
/**
 *
 * <code>onmouseleave</code> attribute for the element. This attribute is
 ...
 *
 */
public class OnMouseLeave extends AbstractEventAttribute
    ...
    public OnMouseLeave(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnMouseLeave(final String preJsFunctionBody,
    ...
    public OnMouseLeave(final String value) {

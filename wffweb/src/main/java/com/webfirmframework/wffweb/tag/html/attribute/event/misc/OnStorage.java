...
/**
 *
 * <code>onstorage</code> attribute for the element. This attribute is supported
 * by multiple tags.
 *
 * @since 2.0.0
 * @author WFF
...
public class OnStorage extends AbstractEventAttribute {
    ...
    public OnStorage(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnStorage(final String preJsFunctionBody,
    ...
    public OnStorage(final String value) {

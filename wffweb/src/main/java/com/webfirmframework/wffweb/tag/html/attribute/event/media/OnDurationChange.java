...
/**
 *
 * <code>ondurationchange</code> attribute for the element. This attribute is
 ...
 *
 */
public class OnDurationChange extends AbstractEventAttribute {

    private static final long serialVersionUID = 1_0_0L;

    {
        super.setAttributeName(AttributeNameConstants.ONDURATIONCHANGE);
        init();
    }
    ...
    public OnDurationChange(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnDurationChange(final String preJsFunctionBody,
    ...
    public OnDurationChange(final String value) {

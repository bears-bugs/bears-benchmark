...
/**
 *
 * <code>ondragend</code> attribute for the element. This attribute is supported
 * by multiple tags.
 *
 * @since 2.0.0
 * @author WFF
...
public class OnDragEnd extends AbstractEventAttribute {
    ...
    public OnDragEnd(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnDragEnd(final String preJsFunctionBody,
    ...
    public OnDragEnd(final String value) {

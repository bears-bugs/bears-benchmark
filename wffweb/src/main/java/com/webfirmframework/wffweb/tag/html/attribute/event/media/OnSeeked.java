...
/**
 *
 * <code>onseeked</code> attribute for the element. This attribute is supported
 * by multiple tags.
 *
 * @since 2.0.0
 * @author WFF
...
public class OnSeeked extends AbstractEventAttribute {
    ...
    {
        super.setAttributeName(AttributeNameConstants.ONSEEKED);
        init();
    }
    ...
    public OnSeeked(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnSeeked(final String preJsFunctionBody,
    ...
    public OnSeeked(final String value) {

...
/**
 *
 * <code>ontouchstart</code> attribute for the element. This attribute is
...
public class OnTouchStart extends AbstractEventAttribute {
    ...
    public OnTouchStart(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnTouchStart(final String preJsFunctionBody,
    ...
    public OnTouchStart(final String value) {

...
/**
 * <i><code>Optimum</code></i> is used to specify the optimal numeric value for
 * <i><code>Meter</code></i> tag.
 *
 * @author WFF
 * @since 2.1.9
 */
public class Optimum extends AbstractAttribute implements MeterAttributable {
     ...
     * @since 2.1.9
     */
    public Optimum(final String value) {

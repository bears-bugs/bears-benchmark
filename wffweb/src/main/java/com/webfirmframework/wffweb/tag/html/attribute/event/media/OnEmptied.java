...
/**
 *
 * <code>onemptied</code> attribute for the element. This attribute is supported
 * by multiple tags.
 *
 * @since 2.0.0
 * @author WFF
 *
 */
public class OnEmptied extends AbstractEventAttribute {
    ...
    public OnEmptied(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnEmptied(final String preJsFunctionBody,
    ...
    public OnEmptied(final String value) {

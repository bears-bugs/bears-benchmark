...
/**
 *
 * <code>onpopstate</code> attribute for the element. This attribute is
...
public class OnPopState extends AbstractEventAttribute {
    ...
    {
        super.setAttributeName(AttributeNameConstants.ONPOPSTATE);
        init();
    }
    ...
    public OnPopState(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnPopState(final String preJsFunctionBody,
    ...
    public OnPopState(final String value) {

...
/**
 *
 * <code>onplaying</code> attribute for the element. This attribute is supported
 * by multiple tags.
 *
 * @since 2.0.0
 * @author WFF
 *
 */
public class OnPlaying extends AbstractEventAttribute {
    ...
    public OnPlaying(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnPlaying(final String preJsFunctionBody,
    ...
    public OnPlaying(final String value) {

...
/**
 *
 * <code>onplay</code> attribute for the element. This attribute is supported by
 * multiple tags.
 *
 * @since 2.0.0
 * @author WFF
 *
 */
public class OnPlay extends AbstractEventAttribute {

    private static final long serialVersionUID = 1_0_0L;

    {
        super.setAttributeName(AttributeNameConstants.ONPLAY);
        init();
    }
    ...
    public OnPlay(final ServerAsyncMethod serverAsyncMethod) {
        setServerAsyncMethod(null, serverAsyncMethod, null, null);
    }

    public OnPlay(final String preJsFunctionBody,
    ...
    public OnPlay(final String value) {
